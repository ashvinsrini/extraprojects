...
plt.savefig(os.path.join(save_pth, 'all_episodes_rewards_{}.png'.format(method)))
plt.show()


series = pd.Series(all_episodes_rewards).rolling(window = 50).mean()
plt.figure(2)
plt.plot(series)
plt.savefig(os.path.join(save_pth, 'all_episodes_rewards_rollingmean_{}.png'.format(method)))
plt.show()
